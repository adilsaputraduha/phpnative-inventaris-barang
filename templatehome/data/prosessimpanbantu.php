<?php 
    ...
    if (isset($_POST['ok'])) {
        ...
        if ($tambahbarang) {
            echo "<script>   document.location='home.php?p=formtambahbarangkeluar'</script>";
        } else {
            echo "Gagal Tambah Barang";
        }

    } elseif (isset($_POST['simpankeluar'])) {
        ...
        $sql_tambah_brgmasuk = "INSERT INTO barangkeluar1810005 VALUES('$nofak','$tglmasuk','$kdpem')";
        $tambahbrgmasuk = mysql_query($sql_tambah_brgmasuk);
        
        $sql_tambah_detail_brg = "INSERT INTO detailkeluar1810005(detailnofakkeluar1810005,detailkeluarkdbrg1810005,
        detailkeluarqty1810005,detailkeluarhrg1810005) select '$nofak',idbrg1810005,qty1810005,hrg1810005 from bantu1810005";
        $tambahdetail_brg = mysql_query($sql_tambah_detail_brg);
        ...
        if ($tambahbrgmasuk) {
            echo "<script>   document.location='home.php?p=databarangkeluar'</script>";
        } else {
            echo "Gagal Tambah Jadwal";
        }
