        ...
        <table border="1" width="100%" class="table1" align="center">
            ...
            <?php
                ...
                if (isset($_POST['cetak'])) {
                    ...
                    $sql = mysql_query("SELECT * from pelanggan1810005 where kodeplg1810005 between '$ko' and '$kod'");
                    ...
                    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                        while($data = mysql_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                            echo "<tr>";
                            echo "<td>".$no++."</td>";
                            echo "<td>".$data['kodeplg1810005']."</td>";
                            echo "<td>".$data['namaplg1810005']."</td>";
                            echo "<td>".$data['alamatplg1810005']."</td>";
                            echo "<td>".$data['notlpplg1810005']."</td>";
