        ...
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                ...
                <hr>
                    <div class="row">
                        <div class="col-md-6">
                            <form role="form" method="POST" action="data/lapbarangmasuk.php" name="brgmasuk" id="finput">
        ...
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                ...
                <hr>
                    <div class="row">
                        <div class="col-md-6">
                            <form role="form" method="POST" action="data/lapbarangmasukpertahun.php" name="brgmasuk" id="finput">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label class="">Tahun</label>
                                        <div class="form-group">
