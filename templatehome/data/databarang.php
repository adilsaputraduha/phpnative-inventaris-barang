    ...
    <div class="card">  
        <div class="app-main__inner">
            <div class="box-body">
                <?php
                    include("../koneksi.php");
                    $sql_view = mysql_query("SELECT * FROM barang1810005 ORDER BY kdbrg1810005 ASC");
                    ...
                    <table id="databarang" name="databarang" class="table table-striped table-simple data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['kdbrg1810005'] ?></td>
                                <td><?php echo $data['namabrg1810005'] ?></td>
                                <td><?php echo $data['satuanbrg1810005'] ?></td>
                                <td><?php echo $data['hargabrg1810005'] ?></td>
                                <td><?php echo $data['stokbrg1810005'] ?></td>
                                <td>
                                    <a href="home.php?p=formeditbarang&kdbrg=<?php echo $data['kdbrg1810005'] ?>" 
                                    class="btn btn-info btn-sm"><span class="pe-7s-pen"
                                    aria-hidden="true"></span> Edit</a>
                                    <a href="home.php?p=proseshapusbarang&kdbrg=<?php echo $data['kdbrg1810005'] ?>" 
