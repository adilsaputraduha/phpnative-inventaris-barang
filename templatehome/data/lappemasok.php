        ...
        <table border="1" width="100%" class="table1" align="center">
            ...
            <?php
                ...
                if (isset($_POST['cetak'])) {
                    ...
                    $sql = mysql_query("SELECT * from pemasok1810005 where kodepmsk1810005 between '$ko' and '$kod'");
                    ...
                    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                        while($data = mysql_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                            echo "<tr>";
                            echo "<td>".$no++."</td>";
                            echo "<td>".$data['kodepmsk1810005']."</td>";
                            echo "<td>".$data['namapmsk1810005']."</td>";
                            echo "<td>".$data['alamatpmsk1810005']."</td>";
                            echo "<td>".$data['notlppmsk1810005']."</td>";
