        ...
        <!-- <div class="app-main__inner"> -->
            <div class="tab-content">
                <!-- <div class="main-card mb-3 card"> -->
                    <div class="card-body"><h5 class="card-title"><i>*Isikan data barang dengan lengkap</i></h5><br>
                        <form class="forms-sample" method="POST" role="form" action="home.php?p=prosestambahbarang">    
                            <table id="datamodaljenis" class="table table-striped responsive-utilities jambo_table" > 
                                <div class="position-relative form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="kdbrg" class="form-control" placeholder="Kode barang" autocomplete="off" required>
                                    </div>
                                </div> 
                                <div class="position-relative form-group">
                                    <label class="col-sm-2 col-form-label"><h6>Nama Barang</h6></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="namabrg" class="form-control" placeholder="Nama barang" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="position-relative form-group">
                                    <label class="col-sm-2 col-form-label"><h6>Satuan Barang</h6></label>
                                    <div class="col-sm-4">
                                        <input type="text" name="stuanbrg" class="form-control" placeholder="Satuan barang" autocomplete="off" required>
                                    </div> 
                                </div> 
                                <div class="position-relative form-group">
                                    <label class="col-sm-2 col-form-label"><h6>Harga Barang</h6></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="hrgbrg" class="form-control" placeholder="Harga barang" autocomplete="off" required>
                                    </div> 
                                </div>
                                <div class="position-relative form-group">
                                    <label class="col-sm-2 col-form-label"><h6>Stok Barang</h6></label>
                                    <div class="col-sm-2">
                                        <input type="text" name="stokbrg" class="form-control" placeholder="Stok barang" autocomplete="off" required>
                                    </div>
                                </div>
                            </table>
