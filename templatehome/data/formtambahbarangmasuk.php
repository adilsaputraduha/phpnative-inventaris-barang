...
<?php
    include "../koneksi.php";
    $today = date("Ymd");
    $query1 = "SELECT max(nofakmasuk1810005) as maxID FROM barangmasuk1810005 WHERE nofakmasuk1810005 LIKE '$today%'";
                        ...
                        <table id="datajadwal" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="home.php?p=hapustem&kdbrg=<?php echo $row['idbrg1810005'] ?>"
