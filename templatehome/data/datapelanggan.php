    ...
    <div class="card"> 
        <div class="app-main__inner">
            <div class="box-body">
                ...
                ?>
                <a href="home.php?p=formtambahpelanggan" class="btn btn-primary btn-lg col-md-2">
                    <span class="pe-7s-plus" aria-hidden="true"></span> TAMBAH DATA
                </a>
                <br><br>
                <div class="container">
                    <table id="datapelanggan" name="datapelanggan" class="table table-striped table-simple data">
                        <thead>
                        <tr>
                            <th>No</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['kodeplg1810005'] ?></td>
                                <td><?php echo $data['namaplg1810005'] ?></td>
                                <td><?php echo $data['alamatplg1810005'] ?></td>
                                <td><?php echo $data['notlpplg1810005'] ?></td>
                                <td>
                                    <a href="home.php?p=formeditpelanggan&kodepelg=<?php echo $data['kodeplg1810005'] ?>" 
                                    class="btn btn-info btn-sm"><span class="pe-7s-pen"
                                    aria-hidden="true"></span> Edit</a>
                                    <a href="home.php?p=proseshapuspelanggan&kodepelg=<?php echo $data['kodeplg1810005'] ?>" 
