    ...
    <div class="row">
        <div class="col-md-6">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">Laporan Data Barang</h5>
                <hr>
                    <div class="row">
                        <div class="col-md-8">
                            <form role="form" method="POST" action="data/lapbarang.php" name="barang" id="finput">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select id="kode1" name="kode1" class="custom-select">
                                            ...
                                            ?>
                                                <option value="<?=$data['kdbrg1810005']?>"><?=$data['kdbrg1810005']?>~<?=$data['namabrg1810005']?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
